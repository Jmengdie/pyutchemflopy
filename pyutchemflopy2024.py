...
perlen = [50, 3600, 2920]  # 应力期长度，稳定流为任意值，非稳定流不同数值代表天数
nstp = [50, 360, 292]  # 每个应力期的时间步数，如100意为将一个应力期的100天划分为100次
...
btn = flopy.mt3d.Mt3dBtn(mt, sconc=sconc, prsity=prsity, thkmin=0.01, tunit='D', munit='μg/L',
                         nprs=9, timprs=[730, 1460, 2190, 2920, 3650, 4380, 5110, 5840, 6570], icbund=icbund)
...
# 平面单图输出
selected_time_step = 9  # 选择要查看的时间步，例如第5个时间步
selected_layer = 4  # 选择要查看的地层，例如第4层
...
# 剖面单图输出
selected_time_step = 9  # 选择时间步，例如第 5 个时间步
