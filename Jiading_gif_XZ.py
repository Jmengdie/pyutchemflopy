...
"""
 @Author: Jane
 @FileName: Jiading_gif_XZ.py
 @DateTime: 2024/10/16 16:25
 @SoftWare: PyCharm
"""
# 该程序用于生成不同时期剖面分布图，然后利用多张图片合成一张动图
...
# extract the data of Sn in specific row
# i表示地层数
for i in [30.138976, 60.276496, 90.143064, 120.319898, 150.240348, 180.176326, 210.502239, 240.304684, 270.271574,
    ...
    main_keyword1 = f'{i}'
    # 关键词2：提取对应相
    main_keyword2 = 'SAT. OF PHASE	2 	IN LAYER            25'
    ...
    folder_path = r'H:\BaiduSyncdisk\08researchprogress\04Simulation\01_JiaDing_test\pyutchemflopy_Jiading_test3\gif_XZ'
    file_name = f'Sn_row25_{i}.png'
    plt.savefig(os.path.join(folder_path, file_name), format='png', dpi=300)  # 保存为PNG格式，DPI为300


# 合成GIF图片
# 图片文件夹路径和输出GIF文件路径
image_folder = r'H:\BaiduSyncdisk\08researchprogress\04Simulation\01_JiaDing_test\pyutchemflopy_Jiading_test3\gif_XZ'
